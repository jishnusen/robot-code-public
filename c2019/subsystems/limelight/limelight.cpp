...
void Limelight::Update() {
  ...
  double back_latency = table->GetEntry("tl").GetDouble(-1000);
  double bottom_latency = table->GetEntry("tl").GetDouble(-1000);
  ...
  status->set_back_limelight_ok(back_bad_ticks_ < 3);
  status->set_bottom_limelight_ok(back_bad_ticks_ < 3);
