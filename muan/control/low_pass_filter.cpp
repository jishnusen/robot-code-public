#include "muan/control/low_pass_filter.h"
...
LowPassFilter::LowPassFilter(float iCutOffFrequency)
    : output(0), cutOffFrequency(iCutOffFrequency), ePow(0) {}
...
float LowPassFilter::getOutput() { return output; }

float LowPassFilter::getCutOffFrequency() { return cutOffFrequency; }
